...
const NoStockWarning = (props) => {
    ...
    const fetchProductList = () => {
        ProductServiceService.fetchNoStockWarning(0)
            .then(response => {
    ...
    const fetchProductByCategoryId = () => {
        ...
        ProductServiceService.fetchNoStockWarning(categoryId)
            .then(response => {
                setProductList(response.data);
    ...
    return (
        <div>
            ...
            <br></br>
            <legend align="center" style={{ fontWeight: 'bold' }} > No Stock Warning   </legend>
