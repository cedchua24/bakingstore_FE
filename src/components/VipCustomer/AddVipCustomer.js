...
const AddVipCustomer = (props) => {
    ...
    const saveVipCustomer = () => {
        ...
        VipCustomerService.sanctum().then(response => {
            VipCustomerService.create(vipCustomer)
                .then(response => {
                    if (props.onSaveVipCustomerData) {
                        props.onSaveVipCustomerData(response.data);
                    }
                    setVipCustomer({
                        id: 0,
                        vip_name: '',
                ...
                .catch(e => {
                    ...
                    setValidator({
                        severity: 'error',
                        message: 'Unable to save VIP Customer Template',
                        isShow: true,
                    });
                    setSubmitLoadingAdd(false);
                    setIsAddDisabled(false);
        ...
        <div>
            ...
            <Form>
                ...
                <Form.Group className="mb-3" controlId="formVipColor">
                    ...
                    <Form.Control type="color" value={vipCustomer.vip_color} name="vip_color" onChange={onChangeInput} />
                </Form.Group>
