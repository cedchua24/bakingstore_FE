...
const CustomerBacklog = () => {
    ...
    const validate = (values) => {
        ...
        if (customerTransaction.required_amount == 0) {
            errors.required_amount = "Amount Required!";
        }
    ...
    const onChangeCustomerSupport = (e) => {
        ...
        if (e.target.type === 'checkbox') {
            if (e.target.checked === true) {
                setCustomerSupport({ ...customerSupport, backlog: 0, chat: 1 });
            } else {
    ...
    const onchangeBacklog = (e) => {

        console.log("error", e.target.checked)
        if (e.target.type === 'checkbox') {
            if (e.target.checked === true) {
                setCustomerSupport({ ...customerSupport, backlog: 1, chat: 0, promo: 0 });
            } else {
                setCustomerSupport({ ...customerSupport, backlog: 0 });
            }
        } else {
            setCustomerSupport({ ...customerSupport, backlog: e.target.value });
        }
    }
    ...
    const onChangeCustomerPromo = (e) => {
        ...
        if (e.target.type === 'checkbox') {
            if (e.target.checked === true) {
                setCustomerSupport({ ...customerSupport, backlog: 0, promo: 1 });
            } else {
    ...
    return (
        <div>
            ...
            <Form>
                ...
                {formErrors.required_amount && <p style={{ color: "red" }}>{formErrors.required_amount}</p>}
                <Form.Group className="w-25 mb-3" controlId="formBasicEmail">
            ...
            >
                <Box sx={style}>
                    ...
                    <Form.Group className="mb-3" controlId="formBasicEmail">
                        <Form.Label>Move to Backlog ? </Form.Label>

                        <Checkbox
                            checked={customerSupport.backlog == 1 ? true : false}
                            onChange={onchangeBacklog}
